...
import os
import json
from cs336_basics.utils.io import gpt2_bytes_to_unicode
...
tokenizer = Tokenizer.from_files("./tests/fixtures/gpt2_vocab.json", "./tests/fixtures/gpt2_merges.txt", ["<|endoftext|>"])
encode_string = tokenizer.encode("Héllò hôw <|endoftext|><|endoftext|> are ü? 🙃<|endoftext|>")
